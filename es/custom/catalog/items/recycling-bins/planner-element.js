...
export default {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return React.createElement(
      ...
      React.createElement('rect', { key: '2', x: '50', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      React.createElement('rect', { key: '3', x: '100', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      React.createElement('rect', { key: '4', x: '150', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      React.createElement('rect', { key: '5', x: '200', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      React.createElement('line', { key: '7', x1: 3 * WIDTH, x2: 3 * WIDTH, y1: DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      React.createElement('line', { key: '8', x1: 2.75 * WIDTH, x2: 3 * WIDTH, y1: 1.2 * DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      React.createElement('line', { key: '9', x1: 3 * WIDTH, x2: 3.25 * WIDTH, y1: 1.5 * DEPTH, y2: 1.2 * DEPTH, style: arrow_style }),
      React.createElement(
        'text',
