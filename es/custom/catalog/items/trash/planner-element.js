...
export default {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return React.createElement(
      ...
      React.createElement('line', { key: '2', x1: 0, x2: 0, y1: RADIUS, y2: 1.5 * RADIUS, style: arrow_style }),
      React.createElement('line', { key: '3', x1: -RADIUS / 2 + .25 * RADIUS, x2: -RADIUS / 2 + RADIUS / 2, y1: 1.2 * RADIUS, y2: 1.5 * RADIUS, style: arrow_style }),
      React.createElement('line', { key: '4', x1: 0, x2: -RADIUS / 2 + .75 * RADIUS, y1: 1.5 * RADIUS, y2: 1.2 * RADIUS, style: arrow_style }),
      React.createElement(
        'text',
        { key: '5', cx: '0', cy: '0',
