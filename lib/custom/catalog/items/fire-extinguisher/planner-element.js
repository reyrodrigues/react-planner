...
function makeObjectMaxLOD() {
  ...
  var gageImage = textureLoader.load(require('./gage-image.png'));
  ...
  var labelImage = textureLoader.load(require('./label-image.png'));
...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('ellipse', { key: '1', cx: '0', cy: '0', rx: RADIUS + 5, ry: RADIUS,
        style: { stroke: element.selected ? '#0096fd' : '#000', strokeWidth: "2px", fill: "#ff0000" } }),
      _react2.default.createElement('line', { key: '2', x1: 0, x2: 0, y1: RADIUS, y2: 2 * RADIUS, style: arrow_style }),
      _react2.default.createElement('line', { key: '3', x1: -RADIUS / 2 + .15 * RADIUS, x2: -RADIUS / 2 + RADIUS / 2, y1: 1.2 * RADIUS, y2: 2 * RADIUS,
        style: arrow_style }),
      _react2.default.createElement('line', { key: '4', x1: 0, x2: -RADIUS / 2 + .85 * RADIUS, y1: 2 * RADIUS, y2: 1.2 * RADIUS, style: arrow_style }),
