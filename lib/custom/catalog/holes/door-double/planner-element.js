  ...
  render2D: function render2D(element, layer, scene) {
    ...
    if (flip) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('path', { key: '1', d: arcPath, style: arcStyle, transform: 'translate(' + 0 + ',' + -holeWidth / 4 + ')' }),
        _react2.default.createElement('line', { key: '2', x1: 0, y1: 0 - epsilon, x2: 0, y2: -holeWidth / 4 - epsilon, style: holeStyle }),
        _react2.default.createElement('path', { key: '3', d: arcPath2, style: arcStyle, transform: 'translate(' + holeWidth + ',' + (-holeWidth / 2 - holeWidth / 4) + ') rotate(90)' }),
        _react2.default.createElement('line', { key: '4', x1: holeWidth, y1: 0 - epsilon, x2: holeWidth, y2: -holeWidth / 2 - holeWidth / 4 - epsilon, style: holeStyle }),
      ...
      return _react2.default.createElement(
        'g',
        { transform: 'translate(' + -element.properties.get('width').get('length') / 2 + ', 0)' },
        _react2.default.createElement('path', { key: '1', d: arcPath, style: arcStyle, transform: 'translate(' + holeWidth + ',' + holeWidth / 4 + ') rotate(180)' }),
        _react2.default.createElement('line', { key: '2', x1: 0, y1: 0 - epsilon, x2: 0, y2: holeWidth / 2 + holeWidth / 4 - epsilon, style: holeStyle }),
        _react2.default.createElement('path', { key: '3', d: arcPath2, style: arcStyle, transform: 'translate(' + 0 + ',' + (holeWidth / 2 + holeWidth / 4) + ') rotate(270)' }),
        _react2.default.createElement('line', { key: '4', x1: holeWidth, y1: 0 - epsilon, x2: holeWidth, y2: holeWidth / 4 - epsilon, style: holeStyle }),
        _react2.default.createElement('path', { key: '5', d: holePath, style: holeStyle })
      );
    }
  },
