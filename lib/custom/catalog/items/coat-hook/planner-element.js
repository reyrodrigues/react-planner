...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('line', { key: '2', x1: WIDTH / 2, x2: WIDTH / 2, y1: DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      _react2.default.createElement('line', { key: '3', x1: .45 * WIDTH, x2: WIDTH / 2, y1: 1.2 * DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      _react2.default.createElement('line', { key: '4', x1: WIDTH / 2, x2: .55 * WIDTH, y1: 1.5 * DEPTH, y2: 1.2 * DEPTH, style: arrow_style }),
