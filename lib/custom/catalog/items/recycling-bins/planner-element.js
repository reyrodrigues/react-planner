...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      'g',
      { transform: 'translate(' + -WIDTH * 3 + ',' + -DEPTH / 2 + ')' },
      _react2.default.createElement('rect', { key: '1', x: '0', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      _react2.default.createElement('rect', { key: '2', x: '50', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      _react2.default.createElement('rect', { key: '3', x: '100', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      _react2.default.createElement('rect', { key: '4', x: '150', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      _react2.default.createElement('rect', { key: '5', x: '200', y: '0', width: WIDTH, height: DEPTH, style: rect_style }),
      _react2.default.createElement('line', { key: '7', x1: 3 * WIDTH, x2: 3 * WIDTH, y1: DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      _react2.default.createElement('line', { key: '8', x1: 2.75 * WIDTH, x2: 3 * WIDTH, y1: 1.2 * DEPTH, y2: 1.5 * DEPTH, style: arrow_style }),
      _react2.default.createElement('line', { key: '9', x1: 3 * WIDTH, x2: 3.25 * WIDTH, y1: 1.5 * DEPTH, y2: 1.2 * DEPTH, style: arrow_style }),
      _react2.default.createElement(
        'text',
        { key: '10', x: '0', y: '0', transform: 'translate(' + WIDTH * 3 + ', ' + DEPTH / 2 + ') scale(1,-1) rotate(' + textRotation + ')',
  ...
  render3D: function render3D(element, layer, scene) {
    ...
    var makeBin = function makeBin(color) {
      ...
      var coloredMaterial = new Three.MeshLambertMaterial({ color: color });
      ...
      var value = new Three.Box3().setFromObject(cestino_carta);
    ...
    var bins = new Three.Object3D();

    // I create all trash bins

    var metalBin = makeBin(0x0000ff);
    var yellowBin = makeBin(0xffff00);
    var brownBin = makeBin(0xeacb9d);
    var paperBin = makeBin(0xffffff);
    var glassBin = makeBin(0x00ff00);
    ...
    if (element.selected) {
      var bbox = new Three.BoxHelper(bins, 0x99c3fb);
