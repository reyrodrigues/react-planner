...
var steel = new Three.MeshLambertMaterial({ color: 0xffffff });
var grey = new Three.MeshLambertMaterial({ color: 0xAAAAAA });
var yellow = new Three.MeshLambertMaterial({ color: 0xFF9933 });
...
function makeObjectMaxLOD(newWidth, newDepth) {
  ...
  var mesh = new Three.Mesh(geometry, steel);
  ...
  var geometry2 = new Three.ExtrudeGeometry(rectShape2, extrudeSettings2);
  var mesh2 = new Three.Mesh(geometry2, steel);
  mesh2.rotation.x += Math.PI / 2;
  mesh2.position.y += newHeight / 2;
  sink.add(mesh2);

  //pipe
  var pipe_p1 = new Three.Mesh(new Three.TorusGeometry(2.5, 2.5, 16, 16, Math.PI / 2), yellow);
  pipe_p1.position.set(newWidth / 2, newHeight / 5.5, newDepth / 2 - 2.5);
  pipe_p1.rotation.z = -Math.PI / 2;
  pipe_p1.rotation.y -= Math.PI / 2;
  sink.add(pipe_p1);

  var cylinderGeometry1 = new Three.CylinderGeometry(2.25, 2.25, newDepth / 2, 80);
  var pipe_p2 = new Three.Mesh(cylinderGeometry1, yellow);
  pipe_p2.rotation.z = Math.PI / 2;
  pipe_p2.rotation.y -= Math.PI / 2;
  pipe_p2.position.set(newWidth / 2, newHeight / 7.5, newDepth / 4.5);
  sink.add(pipe_p2);

  var cylinderGeometry2 = new Three.CylinderGeometry(2.5, 2.5, newDepth / 12, 80);
  var pipe_p3 = new Three.Mesh(cylinderGeometry2, yellow);
  pipe_p3.rotation.y -= Math.PI / 2;
  pipe_p3.position.set(newWidth / 2, newHeight / 4.85, newDepth / 2);
  sink.add(pipe_p3);

  //tap
  var cylinderGeometry66 = new Three.CylinderGeometry(1.25, 1.25, 8, 12);
  var tap_p1 = new Three.Mesh(cylinderGeometry66, grey);
  tap_p1.position.set(newWidth / 2, newHeight / 1.45, 3);
  tap_p1.rotation.z -= Math.PI / 2;
  tap_p1.rotation.y += Math.PI / 2;
  sink.add(tap_p1);

  var cylinderGeometry5 = new Three.CylinderGeometry(2.7, 3, 5, 12);
  var tap_p2 = new Three.Mesh(cylinderGeometry5, grey);
  tap_p2.position.set(newWidth / 2, newHeight / 1.45, 10);
  tap_p2.rotation.z -= Math.PI / 2;
  tap_p2.rotation.y += Math.PI / 2;
  sink.add(tap_p2);

  var cylinderGeometry6 = new Three.CylinderGeometry(2, 2, 5.5, 80);
  var tap_p3 = new Three.Mesh(cylinderGeometry6, blue);
  tap_p3.position.set(newWidth / 2, newHeight / 1.45, 10);
  tap_p3.rotation.z -= Math.PI / 2;
  tap_p3.rotation.y += Math.PI / 2;
  sink.add(tap_p3);

  var curve = new Three.CatmullRomCurve3([new Three.Vector3(-12, -10, 0), new Three.Vector3(-12, -5, 0), new Three.Vector3(0, 0, 0), new Three.Vector3(6, 5, 0), new Three.Vector3(6, 10, 0)]);

  var geometry7 = new Three.TubeGeometry(curve, 32, 1, 16, false);
  var mesh3 = new Three.Mesh(geometry7, grey);
  ...
  //hole
  var cylinderGeometry7 = new Three.CylinderGeometry(newDepth / 20, newDepth / 20, newHeight / 100, 80);
  var blackMaterial = new Three.MeshLambertMaterial({ color: 0x000000 });
  var hole_p1 = new Three.Mesh(cylinderGeometry7, blackMaterial);
  hole_p1.position.set(newWidth / 2, newHeight / 4, newDepth / 2);
  sink.add(hole_p1);

  var cylinderGeometry8 = new Three.CylinderGeometry(newDepth / 10, newDepth / 10, newHeight / 200, 80, 80, false, 0, Math.PI);
  var whiteMaterial = new Three.MeshLambertMaterial({ color: 0xffffff });
  var hole_p2 = new Three.Mesh(cylinderGeometry8, whiteMaterial);
  hole_p2.scale.set(.25, .5, .5);
  hole_p2.rotation.z = Math.PI / 2;
  hole_p2.position.set(newWidth / 2, newHeight / 4, newDepth / 2);
  sink.add(hole_p2);

  var hole_p3 = new Three.Mesh(cylinderGeometry8, whiteMaterial);
  ...
  var hole_p4 = new Three.Mesh(cylinderGeometry8, whiteMaterial);
  ...
  var hole_p5 = new Three.Mesh(cylinderGeometry8, whiteMaterial);
...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('rect', { key: '1', x: '0', y: '0', width: newWidth, height: newDepth, style: rect_style }),
  ...
  render3D: function render3D(element, layer, scene) {
    ...
    var sinkMaxLOD = new Three.Object3D();
    sinkMaxLOD.add(makeObjectMaxLOD(newWidth, newDepth).clone());

    var value = new Three.Box3().setFromObject(sinkMaxLOD);
    ...
    var sinkMinLOD = new Three.Object3D();
