...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('line', { key: '2', x1: WIDTH / 2, x2: WIDTH / 2, y1: TOTAL_DEPTH, y2: 1.5 * TOTAL_DEPTH, style: arrow_style }),
      _react2.default.createElement('line', { key: '3', x1: .25 * WIDTH, x2: WIDTH / 2, y1: 1.2 * TOTAL_DEPTH, y2: 1.5 * TOTAL_DEPTH,
        style: arrow_style }),
      _react2.default.createElement('line', { key: '4', x1: WIDTH / 2, x2: .75 * WIDTH, y1: 1.5 * TOTAL_DEPTH, y2: 1.2 * TOTAL_DEPTH,
        style: arrow_style }),
