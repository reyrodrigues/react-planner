...
export default {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return React.createElement(
      ...
      React.createElement('rect', { key: '1', x: '0', y: '0', width: WIDTH, height: TOTAL_DEPTH,
        style: { stroke: element.selected ? '#0096fd' : '#000', strokeWidth: "2px", fill: "#84e1ce" } }),
      React.createElement('line', { key: '2', x1: WIDTH / 2, x2: WIDTH / 2, y1: DEPTH + DEPTH / 2, y2: 1.5 * DEPTH + DEPTH / 2,
        style: arrow_style }),
      React.createElement('line', { key: '3', x1: .25 * WIDTH, x2: WIDTH / 2, y1: 1.2 * DEPTH + DEPTH / 2, y2: 1.5 * DEPTH + DEPTH / 2,
        style: arrow_style }),
      React.createElement('line', { key: '4', x1: WIDTH / 2, x2: .75 * WIDTH, y1: 1.5 * DEPTH + DEPTH / 2, y2: 1.2 * DEPTH + DEPTH / 2,
        style: arrow_style }),
      React.createElement(
        'text',
        { key: '5', x: '0', y: '0',
  ...
  render3D: function render3D(element, layer, scene) {
    ...
    var valueObject = new Three.Box3().setFromObject(bancoDouble);
    ...
    var boundingBoxDeskAndChair = new Three.Box3().setFromObject(deskAndChairDouble);
