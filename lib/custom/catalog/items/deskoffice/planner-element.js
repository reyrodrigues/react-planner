...
var wood = textureLoader.load(null);
...
exports.default = {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('path', { key: '1', d: 'M ' + (newWidthA / 2 - newWidthB / 2) + ' 0 l ' + (-newWidthA / 2 + newWidthB / 2) + ' ' + newDepth + ' l ' + newWidthA + ' 0 l ' + (-newWidthA / 2 + newWidthB / 2) + -newDepth + ' l ' + -newWidthB + ' 0', stroke: 'red',
