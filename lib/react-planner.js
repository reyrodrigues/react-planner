  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_export3.Content, _extends({ width: contentW + sidebarW, height: contentH, state: extractedState }, props, { onWheel: function onWheel(event) {
