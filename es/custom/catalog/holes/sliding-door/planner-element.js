...
export default {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return React.createElement(
      ...
      React.createElement('line', { key: '1', x1: '0', y1: 0 - epsilon, x2: holeWidth, y2: 0 - epsilon, style: holeStyle,
        transform: 'scale(' + scaleX + ',' + scaleY + ')' }),
      React.createElement('line', { key: '2', x1: pX1, y1: 5 - epsilon, x2: pX2, y2: 5 - epsilon, style: holeStyle2,
        transform: 'scale(' + scaleX + ',' + scaleY + ')' }),
      React.createElement('line', { key: '3', x1: holeWidth, y1: 0 - epsilon, x2: holeWidth, y2: 15 + epsilon, style: holeStyle2,
        transform: 'scale(' + scaleX + ',' + scaleY + ')' }),
      React.createElement('line', { key: '4', x1: '0', y1: 0 - epsilon, x2: '0', y2: 15 + epsilon, style: holeStyle2,
        transform: 'scale(' + scaleX + ',' + scaleY + ')' })
    );
  },
