...
export default {
  ...
  render2D: function render2D(element, layer, scene) {
    ...
    return React.createElement(
      ...
      React.createElement('line', { key: '2', x1: WIDTH / 2, x2: WIDTH / 2, y1: TOTAL_DEPTH, y2: 1.5 * TOTAL_DEPTH, style: arrow_style }),
      React.createElement('line', { key: '3', x1: .25 * WIDTH, x2: WIDTH / 2, y1: 1.2 * TOTAL_DEPTH, y2: 1.5 * TOTAL_DEPTH,
        style: arrow_style }),
      React.createElement('line', { key: '4', x1: WIDTH / 2, x2: .75 * WIDTH, y1: 1.5 * TOTAL_DEPTH, y2: 1.2 * TOTAL_DEPTH,
        style: arrow_style }),
      React.createElement(
        'text',
        { key: '5', x: '0', y: '0',
  ...
  render3D: function render3D(element, layer, scene) {
    ...
    var boxMaterials = [materialTexture, materialTexture, materialTexture, materialTexture, green, materialTexture];

    var plane = new Three.Mesh(new Three.BoxGeometry(cattedraX, cattedraY, 0.04), boxMaterials);
    ...
    var valueObject = new Three.Box3().setFromObject(cattedra);
